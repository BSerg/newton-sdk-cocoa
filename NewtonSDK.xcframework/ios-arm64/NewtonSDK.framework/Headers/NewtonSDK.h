...
- (instancetype)initWithId:(int64_t)id type:(NSDKInstrumentType *)type ticker:(NSString *)ticker isin:(NSString * _Nullable)isin faceUnit:(NSString * _Nullable)faceUnit name:(NSString * _Nullable)name logoSrc:(NSString * _Nullable)logoSrc __attribute__((swift_name("init(id:type:ticker:isin:faceUnit:name:logoSrc:)"))) __attribute__((objc_designated_initializer));
...
- (NSDKOperationInstrumentEntity *)doCopyId:(int64_t)id type:(NSDKInstrumentType *)type ticker:(NSString *)ticker isin:(NSString * _Nullable)isin faceUnit:(NSString * _Nullable)faceUnit name:(NSString * _Nullable)name logoSrc:(NSString * _Nullable)logoSrc __attribute__((swift_name("doCopy(id:type:ticker:isin:faceUnit:name:logoSrc:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithCompanyId:(NSString *)companyId currency:(NSString *)currency instrumentType:(NSDKInstrumentType *)instrumentType __attribute__((swift_name("init(companyId:currency:instrumentType:)"))) __attribute__((objc_designated_initializer));
...
- (NSDKDividendsDescriptor *)doCopyCompanyId:(NSString *)companyId currency:(NSString *)currency instrumentType:(NSDKInstrumentType *)instrumentType __attribute__((swift_name("doCopy(companyId:currency:instrumentType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (NSDKDouble * _Nullable)component8 __attribute__((swift_name("component8()")));
- (NSDKDividendEntity *)doCopyComment:(NSString * _Nullable)comment currency:(NSString *)currency dateHappened:(int64_t)dateHappened fiscalPeriodType:(NSString *)fiscalPeriodType fiscalYear:(NSDKInt * _Nullable)fiscalYear isFuture:(BOOL)isFuture totalValue:(NSDKDouble * _Nullable)totalValue valuePerShare:(NSDKDouble * _Nullable)valuePerShare __attribute__((swift_name("doCopy(comment:currency:dateHappened:fiscalPeriodType:fiscalYear:isFuture:totalValue:valuePerShare:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithCurrency:(NSString *)currency lotSize:(int64_t)lotSize priceStep:(double)priceStep settlementType:(NSString *)settlementType __attribute__((swift_name("init(currency:lotSize:priceStep:settlementType:)"))) __attribute__((objc_designated_initializer));
...
- (double)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSDKStaticParams *)doCopyCurrency:(NSString *)currency lotSize:(int64_t)lotSize priceStep:(double)priceStep settlementType:(NSString *)settlementType __attribute__((swift_name("doCopy(currency:lotSize:priceStep:settlementType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *currency __attribute__((swift_name("currency")));
...
@property (class, readonly) NSDKCurrency *try_ __attribute__((swift_name("try_")));
...
- (instancetype)initWithCurrency:(NSString *)currency value:(double)value __attribute__((swift_name("init(currency:value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) NSDKCurrencyValueCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (double)component2 __attribute__((swift_name("component2()")));
- (NSDKCurrencyValue *)doCopyCurrency:(NSString *)currency value:(double)value __attribute__((swift_name("doCopy(currency:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *currency __attribute__((swift_name("currency")));
